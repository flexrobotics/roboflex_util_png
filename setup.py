...
setup(
    ...
    version='0.1.1',
    description='Roboflex util png Library',
    ...
    ext_modules=[CMakeExtension('roboflex/util/png/roboflex_util_png_ext')],
    cmdclass=dict(build_ext=CMakeBuild),
    py_modules=['__init__'],
    packages=['roboflex.util.png'],
    package_dir={'roboflex.util.png': 'python'}
)
